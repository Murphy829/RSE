...
<img src="http://www.microsate.com/xw/gzdt/202011/W020201127565047800525.jpg"/ width=300><br/>
(The first SAR satellite - Seasat-A: born on 27 June 1978, developed by NASA, the US National Space Agency. Source: NASA)

*Useful resources: a comprehensive and systematic introduction to SAR.
```{=html}
<iframe width="700" height="400" src="https://medium.com/the-downlinq/sar-101-an-introduction-to-synthetic-aperture-radar-2f0b6246c4a0" title="SAR 101: An Introduction to Synthetic Aperture Radar"></iframe>
```
