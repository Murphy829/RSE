...
<img src="https://www.earthdata.nasa.gov/s3fs-public/imported/EMS-Introduction_0.jpeg?VersionId=rSEKLCj0F2zuFCQ6hRTw6zaBBipH.UWY" width="700"><br/>
(Source: NASA. [What is Remote Sensing? \| Earthdata (nasa.gov)](https://www.earthdata.nasa.gov/learn/backgrounders/remote-sensing))

- EMR Interacting with Earth's surface
The EMR, on interaction with earth's surface, experiences a number of changes in the magnitude, direction, wavelength, polarization and phase etc.<br/>
  - Absorption
  - Transmission


- EMR Interacting with Atmospheric
Before radiation used for remote sensing reaches the Earth's surface it has to travel through some distance of the Earth's atmosphere. Particles and gases in the atmosphere can affect the incoming light and radiation. These effects are caused by the mechanisms of scattering and absorption.<br/>
  - Scattering
    - Rayleigh scattering
    - Mie scattering
...
<img src="https://github.com/Murphy829/RSETEST/blob/main/imgs/RSINCHINA.png?raw=true"/ width="700"><br/>
(The need for remote sensing applications in the era of big data in China. Source: Blue Book on China's Space Science and Technology Activities (2020))
...
<img src="https://pic2.zhimg.com/80/v2-2a0b8b2936d79ed76957a688e87c7fa1_1440w.webp"/ width="700">
(Source:[Territorial spatial planning topic: Overview of the territorial spatial planning system](https://zhuanlan.zhihu.com/p/464396400))
